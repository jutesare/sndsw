...
# Time alignment Scifi, T0 = station 0,  mat 0 
       ...
       #digitization parameters
        ...
        for SiPM, constant in calibrationConstants.items():
            setattr(c.MuFilter, 'SiPM_calibration_constant_'+SiPM, 0. if (math.isnan(constant) or constant<=0.) else constant)  # eventually want to absorb the case of nan or negative constants into the constant calculation and leave it out from here, simplifying this line